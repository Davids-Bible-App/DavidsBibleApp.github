...
export default function MenuBtn(props) {
  return (
    <div class="MenuBtn-menu">
      <button
        class="neu-button MenuBtn-menu-toggle ctl-R"
        id="MenuBtn-menu-toggle"
        popovertarget="MenuBtn-menu-items"
        onPointerEnter={() => MenuItems.preload()}
        onPointerDown={(e) => {
          e.stopPropagation();
          MenuItems.preload();
          setShowNested(true);
      ...
      <div class="MenuBtn-bkdrop">
        <Show when={showNested()}>
          <Suspense fallback={null}>
            <MenuItems setTouchActionRestored={props.setTouchActionRestored} />
          </Suspense>
        </Show>
      </div>
    </div>
