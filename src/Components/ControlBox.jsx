...
import {
  ...
  setBibleVersion, setActiveNoteVerse, setTopicController,
  ...
  const [verseData, { refetch }] = createResource(async () => {
    ...
    try {
      ...
      rawSelection.forEach((raw) => {
        ...
        const cleanVerse = allCleanVerses.find(
          (cv) => cv.number === raw.vs && cv.bookId === raw.bk && cv.chapterNumber === raw.ch,
        );
        ...
        <nav class="ControlBox-nav">
          <content class="ControlBox-content" style={expandedCtl() !== 0 ? "height: 8rem; " : "height: 0; "}>
            ...
            <div class="ControlBox-btn-row">
              ...
              <group class="ControlBox-group">
                <button class="ControlBox-button" onClick={() => shareVerse()}>
                  <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
                ...
                <button class="ControlBox-button" onClick={() => topicAddVerse()}>
                  ...
                  >
                    ...
                    <g transform="matrix(1,0,0,1,266.666667,-133.333338)">
                      <path
                        d="M400,175C413.807,175 425,186.193 425,200L425,241.667L466.667,241.667C480.473,241.667 491.667,252.86 491.667,266.667C491.667,280.474 480.473,291.667 466.667,291.667L425,291.667L425,333.333C425,347.14 413.807,358.333 400,358.333C386.193,358.333 375,347.14 375,333.333L375,291.667L333.332,291.667C319.525,291.667 308.332,280.474 308.332,266.667C308.332,252.86 319.525,241.667 333.332,241.667L375,241.667L375,200C375,186.193 386.193,175 400,175Z"
                        fill="currentColor"
                      />
                    </g>
                  </svg>
              ...
              <group class="ControlBox-group">
                <button class="ControlBox-button" onClick={() => verseAddNote()}>
                  ...
                  >
                    ...
                    />
                    <path
                      d="M241.667,300C241.667,286.193 252.86,275 266.667,275L483.333,275C497.14,275 508.333,286.193 508.333,300C508.333,313.807 497.14,325 483.333,325L266.667,325C252.86,325 241.667,313.807 241.667,300Z"
                      fill="currentColor"
                    />
                    <g transform="matrix(1,0,0,1,0,301.041667)">
                      <path
                        d="M241.667,266.667C241.667,252.86 252.86,241.667 266.667,241.667L533.333,241.667C547.14,241.667 558.333,252.86 558.333,266.667C558.333,280.474 547.14,291.667 533.333,291.667L266.667,291.667C252.86,291.667 241.667,280.474 241.667,266.667Z"
                        fill="currentColor"
                      />
                    </g>
                    <g transform="matrix(1,0,0,1,0,34.375)">
                      <path
                        d="M241.667,400C241.667,386.193 252.86,375 266.667,375L533.333,375C547.14,375 558.333,386.193 558.333,400C558.333,413.807 547.14,425 533.333,425L266.667,425C252.86,425 241.667,413.807 241.667,400Z"
                        fill="currentColor"
                      />
                    </g>
